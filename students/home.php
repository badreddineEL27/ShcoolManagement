...
<head>
	<title>Espace Stagaire | ISTAGADIR</title>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<link rel="shortcut icon" href="../students/images/favicon.ico" type="image/x-icon">
	<!-- //lined-icons -->
...
<body>
	<div class="page-container">
								...
								<div class="graph">
									<nav>
										<ul>
											...
											<li><a href="#section-2" class="icon-cup"><i class="lnr lnr-lighter"></i> <span>Changer Mot de Passe</span></a></li>
											<li><a href="#section-3" class="icon-food"><i class="fa fa-user-circle-o" aria-hidden="true"></i> <span>Formateurs</span></a></li>
											<li><a href="#section-4" class="icon-lab"><i class="fa fa-flask"></i> <span>Modules</span></a></li>
											<li><a href="#section-5" class="icon-truck"> <span>Résultats</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										<section id="section-1">
											...
											<div class="mediabox">
												<strong>Informations parentales</strong>
												...
												<p><strong>Téléphone Tuteur: </strong>
										...
										<section id="section-2">
											...
											<div class="col-md-12">
												...
												<i class="fa fa-key"></i>	</span>
													<input type="password" class="form-control1 icon" name="old_password" placeholder="Mot de passe actuel">
		...
		<div class="sidebar-menu">
			...
			<!--/down-->
			<div class="down">
				<a href="index.html"><img src="../students/images/in2.jpg"></a>
