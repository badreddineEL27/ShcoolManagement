...
<form method="post">
	<div class="col-md-12 form-group1 group-mail">
					<label class="control-label">Ajouter une période d'examen</label>
					<input type="text" placeholder="Premier Période" required="" name="Nepdev_exam_term">
				</div>
			...
			<form method="post">
					...
					<label class="control-label">Nom de la table</label>
					<input type="text" placeholder="Nom de la table eg: Class 1" required="" name="Nepdev_table_Name">
				</div>
				...
				<div class="col-md-6 form-group1 form-last">
						<label class="control-label">Nom de Stagiaire</label>
					...
					<div class="clearfix"> </div>
						...
						<div class="col-md-6 form-group1">
						<label class="control-label">Module</label>
						<input type="text"  name="subject5" value="Social"Module
					</div>
						<div class="clearfix"> </div>
								<div class="col-md-6 form-group1 form-last">
						<label class="control-label">Module</label>
						...
						<div class="col-md-6 form-group1">
						<label class="control-label">Période d'examen</label>
