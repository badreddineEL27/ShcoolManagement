    ...
    <a class="navbar-brand" href="index.php">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="" style="color: #ffc107;">OFPPT</a>
          </li>
          <li class="nav-item">
...
<!--********************************************************************************************-->
<section class="ista-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>A PROPOS</h2>
      <p><a href="index.php" style="color: #ffc107;">Accueil</a> &nbsp; / &nbsp; OFPPT</p>
    </div>
  </div>
</section>
<!--********************************************************************************************-->
<!-- content-with-photo4 block -->
<section class="ista-content-with-photo-4">
        ...
        <div class="container py-md-5">
            <div class="cwp4-two row">
                <div class="cwp4-text col-lg-6">
                        <h3>OFPPT</h3>
                        Fondation 1974
                    <p>L'Office de la formation professionnelle et de la promotion du travail (OFPPT) est un opérateur public en formation professionnelle, couvrant le territoire marocain. Il a une capacité d'accueil de plus de 500 000 stagiaires dans 187 filières diplômantes et 133 qualifiantes.</p>
                  
                    <ul class="cont-4">
                        <li><span class="fa fa-check"></span>Formation Initiale </li>
                        <li><span class="fa fa-check"></span>Formation Continue</li>
                        <li><span class="fa fa-check"></span>Formation Qualifiante</li>
                        <li><span class="fa fa-check"></span>Cours du soir</li>
                    </ul>
                </div>
                <div class="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                    <img src="assets/images/pedagogie-768x432-1.jpg" class="img-fluid" alt="" />
                </div>
            </div>
        </div>
    </div>
...
<section class="ista-features-1">
	<!-- /features -->
		<div class="features py-4">
			...
			<div class="icon-info">
					...
					<p>La formation initiale est une formation dont le cursus est sanctionné par un diplôme marquant la fin du parcours de formation. 
            Après l’obtention du diplôme, le lauréat est apte à exercer son métier. </p>
			</div>
			</div>	
			<div class="float-mid feature-gd col-lg-4 col-sm-6 mt-sm-0 mt-4">	
      <div class="icon-info">
						<h5>Formation Qualifiante</h5>
						<p>Les Formations Qualifiantes sont des formations de courte durée, de trois à neuf mois, 
              qui complètent la formation initiale et ouvrent davantage les portes du marché du travail. 
						</p>
					</div>
			</div> 
				<div class="float-rt feature-gd col-lg-4 col-sm-6 mt-lg-0 mt-4">	
					...
					<div class="icon-info">
						<h5>Cours du soir</h5>
						<p>Alternative par excellence pour la formation et le perfectionnement des salariés et des demandeurs d'emploi. 
              Les cours du soir offrent un diplôme équivalent à celui des formations en cours du jour.
						</p>
					</div>
			</div>	 
		</div>  
  ...
  <!--********************************************************************************************-->
<section class="ista-feature-2">
		<div class="grid top-bottom py-5">
			<div class="container py-md-5">
				<div class="heading text-center mx-auto">
					<h3 class="head">Pourquoi ISTA - AGADIR</h3>
					<p class="my-3 head"> Le choix de poursuivre ses études en OFPPT est souvent perçu comme un choix d’une voie difficile. 
            A ISTA - AGADIR, nous savons faire de ce choix une expérience agréable, passionnante et surtout intéressante. </p> 
	</div>
				<div class="middle-section row mt-5 pt-3">
					<div class="three-grids-columns col-lg-3 col-sm-6 text-center">
						...
						<h4>Certification</h4>
						<p>Axée sur l’approche par compétences, ISTA - Agadir a mis en place plusieurs centres de certifications des compétences.</p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-sm-0 mt-5 text-center">
						...
						<h4>Pédagogie</h4>
						<p>Basées sur un grand équilibre entre Hard Skills et Soft Skills, ainsi que sur une orientation forte vers le développement de l’esprit entrepreneurial.</p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-lg-0 mt-5 text-center">
						...
						<h4>Bibliothèque</h4>
						<p>Engagé sur tous les fronts de la recherche d’excellence afin de permettre à ses stagiaires.</p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-lg-0 mt-5 text-center">
						<div class="icon"> <span class="fa fa-bed" aria-hidden="true"></span></div>
						<h4>Campus Life</h4>
						<p>Les clubs des stagiaires ISTA - AGADIR procurent une expérience d’apprentissage distincte hors des salles de classe par rapport à la communication, le leadership, le networking et le travail d’équipe.</p>
					</div>
				</div>
			</div>
		</div>
...
<section class="teams text-center py-5" id="team">
		<div class="container py-xl-5 py-lg-3">
			<div class="heading text-center mx-auto">
				<h3 class="head">Notre Administration</h3>
				<p class="my-3 head">Personnes Exceptionnelles, Soins Exceptionnels</p>
			</div>
...
<!--********************************************************************************************-->
<div class="ads">
          <img src="assets/images/takwin.png" alt="ADS" style="max-width: 100%; height: auto;">     
</div>
<!--********************************************************************************************-->
<!-- grids block 5 -->
          ...
          <div class="d-grid grid-col-4 footer-top-29">
              ...
              <div class="footer-list-29 footer-2">
                  <ul>
                      ...
                      <li><a href="#contact">Formation Hybride</a></li>
                      <li><a href="#contact">Trouver un stage</a></li>
                      <li><a href="#contact">Entreprenariat</a></li>
                      <li><a href="#contact">Programme d’Innovation Entrepreneuriale (PIE)</a></li>
                      <li><a href="#contact">Foire aux questions</a></li>
                      <li><a href="#contact">Règlement intérieur</a></li>
                  </ul>
              </div>
              ...
              <div class="footer-list-29 footer-4">
                  <ul>
                      ...
                      <li><a href=""  style="color: #ffc107;">OFPPT</a></li>
